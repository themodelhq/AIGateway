...
export async function seedModelsIfEmpty() {
  ...
  const models = [
    ...
    // OpenRouter FREE
    { name: "OpenRouter Free Router",   provider: "OpenAI",    modelId: "openrouter/free",                        maxTokens: 200000, costPer1kTokens: 0,       description: "Auto-selects best free model — no credit card needed" },
    { name: "LLaMA 3.3 70B (Free)",     provider: "Meta LLaMA",modelId: "meta-llama/llama-3.3-70b-instruct:free", maxTokens: 66000,  costPer1kTokens: 0,       description: "Best free general purpose model via OpenRouter" },
    { name: "DeepSeek R1 (Free)",        provider: "OpenAI",    modelId: "deepseek/deepseek-r1:free",              maxTokens: 131000, costPer1kTokens: 0,       description: "Best free reasoning model via OpenRouter" },
    { name: "Qwen3 Coder (Free)",        provider: "OpenAI",    modelId: "qwen/qwen3-coder:free",                  maxTokens: 262000, costPer1kTokens: 0,       description: "Best free coding model via OpenRouter" },
    { name: "Gemma 4 31B (Free)",        provider: "Google Gemini", modelId: "google/gemma-4-31b-it:free",         maxTokens: 262000, costPer1kTokens: 0,       description: "Google Gemma 4 multimodal — free via OpenRouter" },
    { name: "GPT-OSS 120B (Free)",       provider: "OpenAI",    modelId: "openai/gpt-oss-120b:free",               maxTokens: 131000, costPer1kTokens: 0,       description: "OpenAI open-weight 120B MoE — free via OpenRouter" },
    { name: "Nemotron Super 120B (Free)",provider: "OpenAI",    modelId: "nvidia/nemotron-3-super-120b-a12b:free", maxTokens: 262000, costPer1kTokens: 0,       description: "NVIDIA Nemotron reasoning model — free via OpenRouter" },
  ];
